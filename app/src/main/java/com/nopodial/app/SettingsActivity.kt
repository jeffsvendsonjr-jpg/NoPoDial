...
/**
 * Pocket-dial protection settings — the original NoPoDial feature, now one
 * screen of the larger call-journal app. Also hosts the journal's
 * "prompt for a note after calls" toggle.
 */
class SettingsActivity : AppCompatActivity() {

    private lateinit var enabledSwitch: MaterialSwitch
    private lateinit var notePromptSwitch: MaterialSwitch
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notePromptSwitch = findViewById(R.id.switch_note_prompt)
        ...
        notePromptSwitch.isChecked = Prefs.notePromptEnabled(this)
        ...
        notePromptSwitch.setOnCheckedChangeListener { _, checked ->
            Prefs.get(this).edit().putBoolean(Prefs.KEY_NOTE_PROMPT, checked).apply()
        }
